...
Migration compatibility retains `RunSnapshotV5`, reads `RunSnapshotV1` through `RunSnapshotV5`, and never silently treats an older record as v4 or v5. New runs use v6 exact-target authority.
