...
describe("Issue 36 repository release and deletion proof", () => {
  ...
  it("synchronizes all governed release values at 0.2.1-beta.1", () => {
    ...
    expect({
      ...
      package: "0.2.1-beta.1",
      lock: "0.2.1-beta.1",
      lockRoot: "0.2.1-beta.1",
    });
    expect(catalog).toContain('OFFICIAL_ASSET_VERSION = "0.2.1-beta.1"');
  });
});
